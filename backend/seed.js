...
const allProducts = [
  ...
  { id: 40, name: 'Ashwagandha Powder', category: 'herbal', price: '₹299', mrp: '₹399', quantity: '100g', stock: 50, benefits: ['Stress Relief', 'Boosts Energy', 'Improves Vitality'], usage: 'Mix with warm milk before sleep', instructions: 'Consult physician if pregnant', image: 'https://images.unsplash.com/photo-1596003906949-67221c37965c?auto=format&fit=crop&q=80&w=400' },
  { id: 41, name: 'Brahmi Powder', category: 'herbal', price: '₹249', mrp: '₹349', quantity: '100g', stock: 45, benefits: ['Memory Booster', 'Hair Growth', 'Reduces Anxiety'], usage: 'Can be consumed or applied as a hair mask', instructions: 'Store in airtight container', image: 'https://images.unsplash.com/photo-1615485500704-8e990f9900f7?auto=format&fit=crop&q=80&w=400' },
  { id: 42, name: 'Shikakai Powder', category: 'herbal', price: '₹189', mrp: '₹249', quantity: '200g', stock: 80, benefits: ['Natural Cleanser', 'Prevents Dandruff', 'Adds Shine'], usage: 'Mix with water to form paste, apply to hair', instructions: 'Can be mixed with Amla and Reetha', image: 'https://images.unsplash.com/photo-1600857062241-98e5dba7f214?auto=format&fit=crop&q=80&w=400' },
  { id: 43, name: 'Neem Powder', category: 'herbal', price: '₹149', mrp: '₹199', quantity: '150g', stock: 65, benefits: ['Treats Acne', 'Blood Purifier', 'Antibacterial'], usage: 'Apply as face pack or consume small amounts', instructions: 'Very bitter taste', image: 'https://images.unsplash.com/photo-1546466691-1ec856bfdaaf?auto=format&fit=crop&q=80&w=400' },
  { id: 44, name: 'Amla Powder', category: 'herbal', price: '₹229', mrp: '₹299', quantity: '200g', stock: 75, benefits: ['Rich in Vitamin C', 'Hair Strengthening', 'Improves Immunity'], usage: 'Consume with honey or use in hair packs', instructions: 'Keep away from moisture', image: 'https://images.unsplash.com/photo-1590623661136-e0ce11b81604?auto=format&fit=crop&q=80&w=400' },
